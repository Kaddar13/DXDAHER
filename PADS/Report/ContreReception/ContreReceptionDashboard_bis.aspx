...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxDashboardViewer ID="ASPxDashboardViewer1" runat="server"  DashboardSource="~\\PADS\Report\ContreReception\Mar_FlowBooster_STD_TL_BL.xml"  Width="100%"></dx:ASPxDashboardViewer>
</asp:Content>

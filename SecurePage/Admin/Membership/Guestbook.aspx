<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Guestbook.aspx.cs" Inherits="DX_DAHERCMS.SecurePage.Admin.Membership.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:Button ID="PostCommentButton" runat="server" Text="Post Your Comment" 
            onclick="PostCommentButton_Click"  ValidationGroup="EnterComment" />
    </p>
    <hr />

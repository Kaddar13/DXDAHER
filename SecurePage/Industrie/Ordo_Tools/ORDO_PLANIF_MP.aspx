<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ORDO_PLANIF_MP.aspx.cs" Inherits="DX_DAHERCMS.WebForm1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>Plannification Market Place</div>
    ...
    <div class="demo-container no-bg">
        <input type="text" runat="server" id="TargetSlotHiddenField" />
    ...
    <asp:SqlDataSource ID="SchedulerDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:laboConnectionString %>"
        ...
        SelectCommand="SELECT * FROM T_Ordo_Appointments_DragAndDrop" UpdateCommand="UPDATE [T_Ordo_Appointments_DragAndDrop] SET [Start] = @Start, [End] = @End, [Subject] = @Subject WHERE [AppointmentID] = @AppointmentID">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:laboConnectionString %>"
        ...
        SelectCommand="SELECT AppointmentID, Market_Place, Appareil, Poste_Appareil, Magasin_Prenant, Magasin_Cedant, OT_CREEE_LE, NB_LIGNE, Subject, Start, [End], Due, Priority, Locke, Locke_Date, Type_Ordo, Cellule FROM T_Ordo_Appointments_DragAndDrop WHERE (Start IS NULL) AND ([End] IS NULL) AND (Type_Ordo = N'MP')"

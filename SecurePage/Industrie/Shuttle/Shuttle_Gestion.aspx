...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" DataSourceID="DS_Grid" KeyFieldName="ID" Theme="MetropolisBlue" OnCellEditorInitialize="grid_CellEditorInitialize" Caption="Hello">
        ...
        <EditFormLayoutProperties ColCount="2">
            <Items>
                ...
                <dx:GridViewColumnLayoutItem Caption="Num devis AH" ColumnName="Spec_Devis_AH">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="OETP">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Statut">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem Caption="Tarif" ColumnName="Vente">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Metre_Lineaire">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Commentaire">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem Caption="Tx Cible" ColumnName="CT_Taux_Cible">
                </dx:GridViewColumnLayoutItem>
...
<dx:GridViewDataTextColumn FieldName="Navette" VisibleIndex="21"></dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="Statut" VisibleIndex="16">
            </dx:GridViewDataTextColumn>
            <%--DateDepart--%>
            ...
            <dx:GridViewDataTextColumn FieldName="ID_Presta" VisibleIndex="20">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Vente" VisibleIndex="22">
            </dx:GridViewDataTextColumn>
            ...
            <%--Metre--%>
            <dx:GridViewDataComboBoxColumn FieldName="Metre_Lineaire" Visible="False" VisibleIndex="23">
                <PropertiesComboBox AllowNull="False" DataSourceID="DS_Metre" TextField="Qte" ValueField="Qte">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            <dx:GridViewDataTextColumn FieldName="Commentaire" Visible="False" VisibleIndex="24">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CT_Taux_Cible" Visible="False" VisibleIndex="25">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CT_Taux_reel" Visible="False" VisibleIndex="26">
            </dx:GridViewDataTextColumn>
            <%--Depart--%>
            <dx:GridViewDataComboBoxColumn FieldName="Depart" VisibleIndex="3">
                <PropertiesComboBox AllowNull="False" EnableCallbackMode="true">
                    ...
                    <ClearButton Visibility="Auto">
                      ...
                      <Items>
                        ...
                        <dx:ListEditItem Text="Donauworth" Value="Donauworth" />                  
                    </Items>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            <%--Arrivee--%>
            <dx:GridViewDataComboBoxColumn FieldName="Arrivee" VisibleIndex="4">
...
<Styles AdaptiveDetailButtonWidth="22"></Styles>
    ...
    <asp:SqlDataSource ID="DS_Grid" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:Dashboard_ConnectionString %>" 
        ...
        InsertCommand="INSERT INTO [T_Shuttle] ([Depart], [Arrivee], [Type], [Navette], [Tranporteur], [Date_Besoin], [Date_Chargement], [CT_ID_Navette], [Spec_SPEEDUP], [Spec_Devis_AH], [Commentaire], [Spec_Cotation_Initiale], [Spec_Cotation_modifie], [OETP], [CT_Taux_Cible], [CT_Taux_reel], [CT_Jour], [Flux], [Statut], [Spec_Transporteur], [Spec_Num_Commande], [Num_Prefa_Trpt], [Date_Depart], [ID_Presta], [Vente], [Metre_Lineaire]) VALUES (@Depart, @Arrivee, @Type, @Navette, @Tranporteur, @Date_Besoin, @Date_Chargement, @CT_ID_Navette, @Spec_SPEEDUP, @Spec_Devis_AH, @Commentaire, @Spec_Cotation_Initiale, @Spec_Cotation_modifie, @OETP, @CT_Taux_Cible, @CT_Taux_reel, @CT_Jour, @Flux, @Statut, @Spec_Transporteur, @Spec_Num_Commande, @Num_Prefa_Trpt, @Date_Depart, @ID_Presta, @Vente, @Metre_Lineaire)" 
        OldValuesParameterFormatString="original_{0}" 
        SelectCommand="SELECT * FROM [T_Shuttle]" 
        UpdateCommand="UPDATE [T_Shuttle] SET [Depart] = @Depart, [Arrivee] = @Arrivee, [Type] = @Type, [Navette] = @Navette, [Tranporteur] = @Tranporteur, [Date_Besoin] = @Date_Besoin, [Date_Chargement] = @Date_Chargement, [CT_ID_Navette] = @CT_ID_Navette, [Spec_SPEEDUP] = @Spec_SPEEDUP, [Spec_Devis_AH] = @Spec_Devis_AH, [Commentaire] = @Commentaire, [Spec_Cotation_Initiale] = @Spec_Cotation_Initiale, [Spec_Cotation_modifie] = @Spec_Cotation_modifie, [OETP] = @OETP, [CT_Taux_Cible] = @CT_Taux_Cible, [CT_Taux_reel] = @CT_Taux_reel, [CT_Jour] = @CT_Jour, [Flux] = @Flux, [Statut] = @Statut, [Spec_Transporteur] = @Spec_Transporteur, [Spec_Num_Commande] = @Spec_Num_Commande, [Num_Prefa_Trpt] = @Num_Prefa_Trpt, [Date_Depart] = @Date_Depart, [ID_Presta] = @ID_Presta, [Vente] = @Vente, [Metre_Lineaire] = @Metre_Lineaire WHERE [ID] = @original_ID AND (([Depart] = @original_Depart) OR ([Depart] IS NULL AND @original_Depart IS NULL)) AND (([Arrivee] = @original_Arrivee) OR ([Arrivee] IS NULL AND @original_Arrivee IS NULL)) AND (([Type] = @original_Type) OR ([Type] IS NULL AND @original_Type IS NULL)) AND (([Navette] = @original_Navette) OR ([Navette] IS NULL AND @original_Navette IS NULL)) AND (([Tranporteur] = @original_Tranporteur) OR ([Tranporteur] IS NULL AND @original_Tranporteur IS NULL)) AND (([Date_Besoin] = @original_Date_Besoin) OR ([Date_Besoin] IS NULL AND @original_Date_Besoin IS NULL)) AND (([Date_Chargement] = @original_Date_Chargement) OR ([Date_Chargement] IS NULL AND @original_Date_Chargement IS NULL)) AND (([CT_ID_Navette] = @original_CT_ID_Navette) OR ([CT_ID_Navette] IS NULL AND @original_CT_ID_Navette IS NULL)) AND (([Spec_SPEEDUP] = @original_Spec_SPEEDUP) OR ([Spec_SPEEDUP] IS NULL AND @original_Spec_SPEEDUP IS NULL)) AND (([Spec_Devis_AH] = @original_Spec_Devis_AH) OR ([Spec_Devis_AH] IS NULL AND @original_Spec_Devis_AH IS NULL)) AND (([Commentaire] = @original_Commentaire) OR ([Commentaire] IS NULL AND @original_Commentaire IS NULL)) AND (([Spec_Cotation_Initiale] = @original_Spec_Cotation_Initiale) OR ([Spec_Cotation_Initiale] IS NULL AND @original_Spec_Cotation_Initiale IS NULL)) AND (([Spec_Cotation_modifie] = @original_Spec_Cotation_modifie) OR ([Spec_Cotation_modifie] IS NULL AND @original_Spec_Cotation_modifie IS NULL)) AND (([OETP] = @original_OETP) OR ([OETP] IS NULL AND @original_OETP IS NULL)) AND (([CT_Taux_Cible] = @original_CT_Taux_Cible) OR ([CT_Taux_Cible] IS NULL AND @original_CT_Taux_Cible IS NULL)) AND (([CT_Taux_reel] = @original_CT_Taux_reel) OR ([CT_Taux_reel] IS NULL AND @original_CT_Taux_reel IS NULL)) AND (([CT_Jour] = @original_CT_Jour) OR ([CT_Jour] IS NULL AND @original_CT_Jour IS NULL)) AND (([Flux] = @original_Flux) OR ([Flux] IS NULL AND @original_Flux IS NULL)) AND (([Statut] = @original_Statut) OR ([Statut] IS NULL AND @original_Statut IS NULL)) AND (([Spec_Transporteur] = @original_Spec_Transporteur) OR ([Spec_Transporteur] IS NULL AND @original_Spec_Transporteur IS NULL)) AND (([Spec_Num_Commande] = @original_Spec_Num_Commande) OR ([Spec_Num_Commande] IS NULL AND @original_Spec_Num_Commande IS NULL)) AND (([Num_Prefa_Trpt] = @original_Num_Prefa_Trpt) OR ([Num_Prefa_Trpt] IS NULL AND @original_Num_Prefa_Trpt IS NULL)) AND (([Date_Depart] = @original_Date_Depart) OR ([Date_Depart] IS NULL AND @original_Date_Depart IS NULL)) AND (([ID_Presta] = @original_ID_Presta) OR ([ID_Presta] IS NULL AND @original_ID_Presta IS NULL)) AND (([Vente] = @original_Vente) OR ([Vente] IS NULL AND @original_Vente IS NULL)) AND (([Metre_Lineaire] = @original_Metre_Lineaire) OR ([Metre_Lineaire] IS NULL AND @original_Metre_Lineaire IS NULL))">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="DS_Transporteur" runat="server" ConnectionString="<%$ ConnectionStrings:Dashboard_ConnectionString %>" 
        SelectCommand="SELECT DISTINCT Transporteur FROM T_Shuttle_Tarif Where Depart=@param_depart and Arrivee=@param_arrivee and Type=@param_type">
         <SelectParameters>
    ...
    <asp:SqlDataSource ID="DS_Type" runat="server" ConnectionString="<%$ ConnectionStrings:Dashboard_ConnectionString %>" 
            SelectCommand="SELECT DISTINCT Type FROM T_Shuttle_Tarif where Type is not null and Depart=@param_depart and Arrivee=@param_arrivee">
        <SelectParameters>
            <asp:SessionParameter Name="param_depart" DefaultValue="%" SessionField="param_depart" />
            <asp:SessionParameter Name="param_arrivee" DefaultValue="%" SessionField="param_arrivee" />
        </SelectParameters>
    ...
    <asp:SqlDataSource ID="Ds_Arrivee" runat="server" ConnectionString="<%$ ConnectionStrings:Dashboard_ConnectionString %>" 
            SelectCommand="SELECT DISTINCT Arrivee FROM T_Shuttle_Tarif where Depart=@param_depart">
        <SelectParameters>
            <asp:SessionParameter Name="param_depart" DefaultValue="%" SessionField="param_depart" />
        </SelectParameters>
    </asp:SqlDataSource>

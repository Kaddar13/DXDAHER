<%@ Page Title="" Language="C#" MasterPageFile="~/PADS/PADS.Master" AutoEventWireup="true" CodeBehind="GUICHET_NEW.aspx.cs" Inherits="DX_DAHERCMS.ToolBox.SPEEDUP.GUICHET_NEW" %>
                ...
                <dx:LayoutGroup Caption="Demande Guichet">
                    <Items>
                        <dx:LayoutGroup Caption="Informations du demandeur :">
                            <Items>
							<%--Sigle--%>
                                <dx:LayoutItem Caption="Sigle du demandeur :" RowSpan="2">
                        ...
                        <dx:LayoutGroup Caption="Specification de la demande :">
                            <Items>
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxRadioButtonList ID="txt_Enlevement" runat="server">
                                                <Items>
                                                    <dx:ListEditItem Text="Guichet" Value="Guichet" />
                                ...
                                <%--Resa--%>
                                <dx:LayoutItem Caption="Numéro de réservation :">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                ...
                                <%--Reference--%>
                                <dx:LayoutGroup Caption="Référence article :" ColCount="2" RowSpan="2">
                                    <Items>
                                ...
                                <dx:LayoutGroup Caption="Confirmation demandeur :">
                                    <Items>
                                        <dx:LayoutItem Caption="Avoir vérifié que les references ne sont pas soumises à blocage qualité (Blocage Casier)" RequiredMarkDisplayMode="Required">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <dx:LayoutItem Caption="Avoir vérifié au préalable l'ATP" RequiredMarkDisplayMode="Required">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <dx:LayoutItem Caption="Avoir fait valider la réservation par l'ordonnanceur concerné (si le matériel et en code MAN ou LEX, merci de joindre l'accord de l'approvisionneur à cette fiche." RequiredMarkDisplayMode="Required">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <dx:LayoutItem Caption="Piece jointe :" RequiredMarkDisplayMode="Required">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">

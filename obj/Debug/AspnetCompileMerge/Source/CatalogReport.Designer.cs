...
namespace DX_DAHERCMS.CatalogReportTableAdapters {
    ...
    public partial class ReportsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Reports] WHERE (([ReportID] = @Original_ReportID) AND ((@IsNull_Disp" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Reports] ([DisplayName], [LayoutData]) VALUES (@DisplayName, @Layout" +
                "Data);\r\nSELECT ReportID, DisplayName, LayoutData FROM Reports WHERE (ReportID = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Reports] SET [DisplayName] = @DisplayName, [LayoutData] = @LayoutData WHERE (([ReportID] = @Original_ReportID) AND ((@IsNull_DisplayName = 1 AND [DisplayName] IS NULL) OR ([DisplayName] = @Original_DisplayName)));
SELECT ReportID, DisplayName, LayoutData FROM Reports WHERE (ReportID = @ReportID)";
        ...
        public virtual int Delete(int Original_ReportID, string Original_DisplayName) {
        ...
        public virtual int Update(string DisplayName, byte[] LayoutData, int Original_ReportID, string Original_DisplayName, int ReportID) {
            if ((DisplayName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string DisplayName, byte[] LayoutData, int Original_ReportID, string Original_DisplayName) {
            return this.Update(DisplayName, LayoutData, Original_ReportID, Original_DisplayName, Original_ReportID);
        }
    }

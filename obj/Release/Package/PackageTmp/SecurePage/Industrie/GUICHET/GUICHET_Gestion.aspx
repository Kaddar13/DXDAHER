<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GUICHET_Gestion.aspx.cs" Inherits="DX_DAHERCMS.SecurePage.Industrie.GUICHET.GUICHET_GESTION" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        function OnUpdateClick(s, e) {
            ...
            if (typeof (s.cpInfo) != 'undefined') {
                ...
                grid.GetRowValues(grid.GetFocusedRowIndex(), 'UserDemande;IDSPEEDUP;Exclusion;Exlusion_Commentaires;Reference;OT;Reference2;OT2;Reference3;OT3;Reference4;OT4;Reference5;OT5;Guichet_ExclusionMagasin', OnGetRowValues);
                //setTimeout(function () {
                //    location.reload()
                //}, 10);
            }
            ...
            //    grid.customCallbackExecuted = true;
            //    grid.GetRowValues(grid.GetFocusedRowIndex(), 'UserDemande;IDSPEEDUP;Dagedim_LCS;Exclusion;Dagedim_Gare;Exlusion_Commentaires', OnGetRowValues);
            //    //setTimeout(function () {
            //    //    location.reload()
            //    //}, 10);
    ...
    <div>
        ...
        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="IDSPEEDUP" Theme="MetropolisBlue" OnCellEditorInitialize="grid_CellEditorInitialize" OnRowUpdated="grid_RowUpdated" ClientInstanceName="grid">
            ...
            <EditFormLayoutProperties ColCount="2">
                <Items>
                    ...
                    <dx:GridViewLayoutGroup ColCount="3" Caption="Reference :" ColSpan="2" HorizontalAlign="Center" UseDefaultPaddings="False">
                        <Items>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="IDSPEEDUP" ReadOnly="True" VisibleIndex="2" Caption="ID Resa">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="DateDemande" VisibleIndex="4">
                ...
                <dx:GridViewDataTextColumn FieldName="UserDemande" VisibleIndex="8" Caption="Demandeur">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="SU_EOTP" VisibleIndex="18" Caption="Sigle" Visible="false">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Stock_Mag" VisibleIndex="11" Caption="Magasin">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Num_Resa" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Type_Demande" VisibleIndex="20" Visible="false">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="Guichet_RemiseClient" VisibleIndex="5" Caption="Date remise client">
   ...
   s.SetDate(date);
                ...
                <dx:GridViewDataTextColumn VisibleIndex="7" Caption="Message">
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="Reference" VisibleIndex="27" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="OT" VisibleIndex="22" Visible="false">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Quantite" VisibleIndex="32" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>


                <dx:GridViewDataTextColumn FieldName="Reference2" VisibleIndex="28" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="OT2" VisibleIndex="23" Visible="false">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Qte2" VisibleIndex="33" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>



                <dx:GridViewDataTextColumn FieldName="Reference3" VisibleIndex="29" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Qte3" VisibleIndex="34" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="OT3" VisibleIndex="24" Visible="false">
                </dx:GridViewDataTextColumn>


                <dx:GridViewDataTextColumn FieldName="Reference4" VisibleIndex="30" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn FieldName="Qte4" VisibleIndex="35" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="OT4" VisibleIndex="25" Visible="false">
                </dx:GridViewDataTextColumn>


                <dx:GridViewDataTextColumn FieldName="Reference5" VisibleIndex="31" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Qte5" VisibleIndex="36" Visible="false" ReadOnly="true">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="OT5" VisibleIndex="26" Visible="false">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="SU_Commentaire" VisibleIndex="26" Visible="false">
                </dx:GridViewDataTextColumn>
